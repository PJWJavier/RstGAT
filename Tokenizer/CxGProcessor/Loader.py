import pickle
from Tokenizer.BaseTokenizer import BasicTokenizer
...
class Loader(object):
    ...
    def __init__(self, args):
        self.args = args
        self.cons_path = args.cxg_vocab_path + "/construction.pkl"
...
if __name__ == "__main__":
    args = ARG_TEST()
    loader = Loader(args)
    text = ["The staff should be more a bit friendly."]
    tokens = loader.tokenize(text)
    lines = loader.tokens2lines(tokens)
