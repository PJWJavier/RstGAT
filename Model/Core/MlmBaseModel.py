...
from Model.Components import LayerNorm
from Model.Components.act_fun import str2act

class MlmBaseModel(nn.Module):
    """
    BERT exploits masked language modeling (MLM) and Nex Sentence Prediction (NSP)
    This Module is Used For MLM Based
    """
