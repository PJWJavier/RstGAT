from .MlmBaseModel import MlmBaseModel
import torch
from torch import nn

class BertTarget(MlmBaseModel):
    """
    ...
    def forward(self, memory_bank, tgt):
        ...
        output_nsp = torch.tanh(self.nsp_linear_1(memory_bank[:, 0, :]))  # TODO : BERT NSP Task Use [CLS] Tag
